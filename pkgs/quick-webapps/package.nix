...
rustPlatform.buildRustPackage {
  pname = "quick-webapps";
  version = "0.5.3-unstable-2024-11-19";

  src = fetchFromGitHub {
    owner = "cosmic-utils";
    repo = "web-apps";
    rev = "3ca3e95ebc09d68899a2d33e12896c6b73f809a1";
    hash = "sha256-zE5RCuOv/hKXyaYkm5wZ38Vzks4TF7hi5z2LM7rc87Q=";
  };
  ...
  cargoLock = {
    ...
    outputHashes = {
      ...
      "cosmic-config-0.1.0" = "sha256-szcBKXf9ITS1d1gt2m3sZAzmXSHnCC0IyKaPFgmQnBE=";
