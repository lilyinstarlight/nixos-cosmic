...
rustPlatform.buildRustPackage {
  ...
  patches = [
    (fetchpatch {
      name = "install-icon-in-prefix.patch";
      url = "https://github.com/tropicbliss/cosmic-ext-applet-caffeine/pull/3.diff?full_index=1";
      hash = "sha256-JtY12iF5eHphz5LW1KskhhyFmWFppswYqDz7wFH0WRY=";
    })
  ];
